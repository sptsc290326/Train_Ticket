...
-- Mật khẩu mẫu: "password123" (trong thực tế phải hash bcrypt)
-- ----------------------------------------------------------
INSERT INTO `User` (ID, hoTen, email, sdt, matKhau, CCCD, ngaySinh, gioiTinh, vaiTro) VALUES
('U01', 'Nguyen Van Admin',  'admin@traintick.vn',    '0901000001', '$2a$10$exampleHashAdmin123456', '001099000001', '1985-03-15', TRUE,  'ADMIN'),
('U02', 'Tran Thi Lan',      'lan.tran@gmail.com',    '0912345678', '$2a$10$exampleHashUser1234567', '034099012345', '1995-07-20', FALSE, 'KHACH_HANG'),
('U03', 'Le Minh Tuan',      'tuan.le@gmail.com',     '0987654321', '$2a$10$exampleHashUser2345678', '025099054321', '1990-11-05', TRUE,  'KHACH_HANG');
...
('GC005', 'CT01', 'G005', 250000.00, 'DANG_GIU'),
...
('CTV02', 'VE01', 'HK02', 'GC005', 250000.00, 250000.00),  -- Phuc đặt ghế G005 chuyến CT01 (DANG_GIU)
